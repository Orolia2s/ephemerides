...
|$T_{GD1}$|group_delay_differential_1|10||$\mathrm{ns}$|
|$T_{GD2}$|group_delay_differential_2|10||$\mathrm{ns}$|
...
|:------:|:---|---:|:-----|:--:|
||_ignored_|30|||
|$A_{0GPS}$|gps_bias_correction|14||$\mathrm{ns}$|
|$A_{1GPS}$|gps_drift_correction|16||$\mathrm{\frac{ns}{s}}$|
|$A_{0Gal}$|galileo_bias_correction|14||$\mathrm{ns}$|
|$A_{1Gal}$|galileo_drift_correction|16||$\mathrm{\frac{ns}{s}}$|
|$A_{0GLO}$|glonass_bias_correction|14||$\mathrm{s}$|
|$A_{1GLO}$|glonass_drift_correction|16||$\mathrm{\frac{ns}{s}}$|
